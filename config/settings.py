...
# PrioritÃ© Ã  la variable d'environnement DATABASE_URL (Render)

# Sinon fallback sur SQLite pour dÃ©veloppement local

if os.getenv('DATABASE_URL'):

    DATABASES = {

        # Neon.tech : il est recommandÃ© de garder conn_max_age Ã  0 pour Ã©viter de maintenir 

        # des connexions inactives sur une base serverless / poolÃ©e.
    ...
    DATABASES['default']['OPTIONS'] = {'keepalives': 1, 'keepalives_idle': 30, 'keepalives_interval': 10, 'keepalives_count': 5}
...
if not DEBUG:
    ...
    # Pour que Allauth gÃ©nÃ¨re des URLs d'emails en HTTPS
...
# Nombre minimum de bilans de sÃ©ances pour obtenir le badge
...
# IMPORTANT : Cette adresse DOIT Ãªtre vÃ©rifiÃ©e dans votre compte Brevo
