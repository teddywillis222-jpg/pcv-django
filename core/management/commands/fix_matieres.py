...
class Command(BaseCommand):
    help = "Migre et nettoie les noms des matières dans les profils Enfants, Apprenants et Professeurs"

    def handle(self, *args, **kwargs):
        self.stdout.write("Mise à jour des profils Enfant...")
        ...
        for enfant in enfants:
            ...
            if old_val != new_val:
                ...
                count_enfants += 1
        self.stdout.write(self.style.SUCCESS(f"{count_enfants} profils Enfant mis à jour."))

        self.stdout.write("Mise à jour des profils Apprenant...")
        ...
        for apprenant in apprenants:
            ...
            if old_val != new_val:
                ...
                count_apprenants += 1
        self.stdout.write(self.style.SUCCESS(f"{count_apprenants} profils Apprenant mis à jour."))

        self.stdout.write("Mise à jour des profils Professeurs...")
        ...
        for prof in profs:
            ...
            if old_val:
                ...
                if old_val != new_val:
                    ...
                    count_profs += 1
        self.stdout.write(self.style.SUCCESS(f"{count_profs} profils Professeurs mis à jour."))
